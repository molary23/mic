module.exports = function getMessage({ sender, details }) {
  ...
  if (sender === "verify") {
    ...
    let ticketid;
    if (details.forumid.toString().length < 5) {
      ticketid = details.forumid.toString().padStart(5, "0");
    } else {
      ticketid = details.forumid.toString();
    }
    middle = `<tr>
                          <td align="center" style="padding: 0px">
                            <table
                                                                      ...
                                                                      <tbody>
                                                                        <tr>
                                                                          ...
                                                                          >
                                                                            ...
                                                                            >
                                                                              <a
                                                                                href="//dashboard.micearnbusiness.org/user/forum/:${details.forumid}"
                                                                                style="
                                                                                  background: rgba(
                                                                                    64,
                                                                                    89,
                                                                          ...
                                                                          >
                                                                            ...
                                                                            <p
                                                                              style="
                                                                                ...
                                                                                font-size: 16px;
                                                                              "
                                                                            >There has been an update to your ticket. The said ticket number is,
                                                                            </p>
                                                                         <p
                                                                              style="
                                                                                font-size: 18px;
