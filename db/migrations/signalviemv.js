...
const original_query =
  "SELECT Signals.id AS signalid, Signals.signaloption, Signals.takeprofit, Signals.stoploss, Signals.startrange, Signals.endrange, Signals.pip, Signals.status, Signals.createdAt, Signals.updatedAt, Currencies.firstcurrency, Currencies.secondcurrency, Users.username AS provider, Users.id AS providerid FROM Signals INNER JOIN Users ON Users.id = Signals.UserId INNER JOIN Currencies ON Signals.UserId = Currencies.id";
