...
function MainNav(props) {
  ...
  const changeFocus = () => {
    ...
    if (
      ...
      winScroll >= consistent.offsetTop - 150 &&
      ...
      winScroll >= accuracy.offsetTop - 150 &&
      ...
      winScroll >= support.offsetTop - 150 &&
